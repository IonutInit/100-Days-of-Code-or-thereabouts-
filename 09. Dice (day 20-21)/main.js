...
//a script reproducing various faces of two die based on the roll and style of die
...
//I want to call the "die" and "randomNumber" variables as `die${i}` and `randomNumber${i}` respectively
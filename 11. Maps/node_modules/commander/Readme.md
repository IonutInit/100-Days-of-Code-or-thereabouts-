...
Read this in other languages: English | [简体中文](../../../11.%20Maps/node\_modules/commander/Readme\_zh-CN.md)
...
For information about terms used in this document see: [terminology](../../../11.%20Maps/node\_modules/commander/docs/terminology.md)
...
Example file: [options-common.js](../../../11.%20Maps/node\_modules/commander/examples/options-common.js)
...
Example file: [options-defaults.js](../../../11.%20Maps/node\_modules/commander/examples/options-defaults.js)
...
Example file: [options-negatable.js](../../../11.%20Maps/node\_modules/commander/examples/options-negatable.js)
...
Example file: [options-boolean-or-value.js](../../../11.%20Maps/node\_modules/commander/examples/options-boolean-or-value.js)
...
For information about possible ambiguous cases, see [options taking varying arguments](../../../11.%20Maps/node\_modules/commander/docs/options-taking-varying-arguments.md).

### Required option

You may specify a required (mandatory) option using `.requiredOption`. The option must have a value after parsing, usually specified on the command line, or perhaps from a default value (say from environment). The method is otherwise the same as `.option` in format, taking flags and description, and optional default value or custom processing.

Example file: [options-required.js](../../../11.%20Maps/node\_modules/commander/examples/options-required.js)
...
Example file: [options-variadic.js](../../../11.%20Maps/node\_modules/commander/examples/options-variadic.js)
...
Example file: [options-extra.js](../../../11.%20Maps/node\_modules/commander/examples/options-extra.js)
...
Example file: [options-custom-processing.js](../../../11.%20Maps/node\_modules/commander/examples/options-custom-processing.js)
...
You can specify (sub)commands using `.command()` or `.addCommand()`. There are two ways these can be implemented: using an action handler attached to the command, or as a stand-alone executable file (described in more detail later). The subcommands may be nested ([example](../../../11.%20Maps/node\_modules/commander/examples/nestedCommands.js)).
...
Example file: [arguments.js](../../../11.%20Maps/node\_modules/commander/examples/arguments.js)
...
Example file: [thank.js](../../../11.%20Maps/node\_modules/commander/examples/thank.js)
...
Example file: [pm](../../../11.%20Maps/node\_modules/commander/examples/pm/)
...
Example file: [pizza](../../../11.%20Maps/node\_modules/commander/examples/pizza/)
...
Example file: [custom-help](../../../11.%20Maps/node\_modules/commander/examples/custom-help/)
...
Example file: [configure-help.js](../../../11.%20Maps/node\_modules/commander/examples/configure-help.js)
...
Example file: [positional-options.js](../../../11.%20Maps/node\_modules/commander/examples/positional-options.js)
...
Example file: [pass-through-options.js](../../../11.%20Maps/node\_modules/commander/examples/pass-through-options.js)
...
Example file: [configure-output.js](../../../11.%20Maps/node\_modules/commander/examples/configure-output.js)
...
* [deprecated](../../../11.%20Maps/node\_modules/commander/docs/deprecated.md) features still supported for backwards compatibility
* [options taking varying arguments](../../../11.%20Maps/node\_modules/commander/docs/options-taking-varying-arguments.md)
...
Example file: [deploy](../../../11.%20Maps/node\_modules/commander/examples/deploy/)
...
The maintainers of Commander and thousands of other packages are working with Tidelift to deliver commercial support and maintenance for the open source dependencies you use to build your applications. Save time, reduce risk, and improve code health, while paying the maintainers of the exact dependencies you use. [Learn more.](https://tidelift.com/subscription/pkg/npm-commander?utm\_source=npm-commander\&utm\_medium=referral\&utm\_campaign=enterprise\&utm\_term=repo)
